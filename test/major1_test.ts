...
// 	}
//
// 	const uqf1 = tournament.aflBracket.getBracketNode("upperQuarterFinal1");
// 	const uqf1MR = uqf1.match.matchRecord as UpperRecord;
// 	assertEquals(uqf1MR.upperSeed, 1);
//
// 	const uqf2 = tournament.aflBracket.getBracketNode("upperQuarterFinal2");
...
//
// 	const lbr1 = tournament.aflBracket.getBracketNode("lowerBracketRound1");
// 	const lbr1MR = lbr1.match.matchRecord as FullRecord;
// 	assertEquals(lbr1MR.upperSeed, 7);
// 	assertEquals(lbr1MR.lowerSeed, 6);
//
// 	const lbr2 = tournament.aflBracket.getBracketNode("lowerBracketRound2");
